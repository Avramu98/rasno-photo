...
const Review = () => {
  return (
        <Box className='bg-white text-center py-16 flex flex-col'>
            <Container className='flex flex-col gap-8 md:gap-14 items-center' maxWidth='md'>
                <Typography className='text-black text-4xl font-prompt'>
                ...
                <ButtonAnimationWrapper>
                    <Button variant='outlined' className='font-prompt text-md font-bold text-black'>
                        <Link target='_blank'
                ...
                <Typography className='text-primary text-5xl mb-14'>Thank you! :)</Typography>
            </Container>
        </Box>
  );
};
